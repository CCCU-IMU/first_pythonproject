...
kegg_rich <- read.delim(
  "E:/桌面/武汉数据/乌珠穆沁白牛/10-24祖先比例/result/05.loter/enrich/Mo-OD//KEGG/Mo-OD.kegg_rich.xls",
  sep = "\t",
  check.names = FALSE
)

ko_class <- read.delim(
  "E:/桌面/武汉数据/乌珠穆沁白牛//10-24祖先比例/result/05.loter/enrich/Mo-OD/KEGG/Mo-OD.ko_classplot.xls",
  sep = "\t",
  check.names = FALSE
)
